# AGENTS.local.md - Edition-Specific Governance (Magic-Path)
...
|-----|-------|
| Edition | Magic-Path |
| Focus | Custom UX methodology, intuitive workflows and visual storytelling |
...
- **Edition Lead:** Magic-Path AI Agent
